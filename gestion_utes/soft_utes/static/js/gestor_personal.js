document.addEventListener("DOMContentLoaded", function () {
  ...
  const originalAction = URL_CREAR_PERSONAL;
  ...
  botonesEditar.forEach((btn) => {
    btn.addEventListener("click", function () {
      ...
      inputUsername.value = this.getAttribute("data-username") || '';
      if (inputPassword) inputPassword.required = !this.getAttribute("data-username");
      ...
      formElement.action = `/personal/editar/${inputId.value}/`;
      form.style.display = "block";
      btnMostrar.style.display = "none";
    });
  });
